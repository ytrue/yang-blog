window.operateEvents = {
    'click .btn-edit-one': function (e, value, row, index) {
        ...
        layer.open({
            ...
            area: ['900px', '600px'],
            content: '/admin/content/link/update?id=' + id,
        });
    },
    'click .btn-del-one': function (e, value, row, index) {
        let id = row.id;
        deleteData("/admin/content/link/delete", [id]);
    },
};
...
new Vue({
    ...
    data: {
        ...
        data: [],
        options: {
            url: '/admin/content/link/index',         //请求后台的URL（*）
            pk: "id",
            method: 'post',                      //请求方式（*）
            dataType: 'json',
            ...
            queryParams: function (params) {
                ...
                let searchParam = [
                    ...
                    {column: "url", type: "like", value: link},
                    {column: "type", type: "eq", value: type},
                ];
                return {
    ...
    methods: {
        btnAdd: function () {
            layer.open({
                ...
                maxmin: true, //开启最大化最小化按钮
                area: ['900px', '600px'],
                content: '/admin/content/link/add'
            });
        },
        btnEdit: function () {
        ...
        btnDel: function () {
            ...
            deleteData("/admin/content/link/delete", delArr);
        },
        btnRest: function () {
            $("#table").bootstrapTable('refresh');
        },
